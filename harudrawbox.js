...
*/
const GOOGLE_FORM_ID = "1FAIpQLSdFdOvf4zufRoSt0i8UJW3D5cANkp9CwgMNtpKdd1vYPRMnew";
const ENTRY_ID = "entry.314075495";
const GOOGLE_SHEET_ID = "1cA9UqnbIjCe8RB3HqNi_zkUsOJjthfZ6S-WSiUJmcfE";
...
function getX(event) {
  return getMousePos(event).x;
}

function getY(event) {
  return getMousePos(event).y;
}
// --------------------------
